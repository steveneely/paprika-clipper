...
- Sign in normally. Confirm the extension-created connection tab shows a three-second success countdown and closes automatically without copying code, and the popup shows Connected. Other Paprika tabs must stay open.
