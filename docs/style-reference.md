...
The design retains familiar recipe-app conventions while using its own cream scissors icon, muted red accent (#b43e35), dark title, white header, warm gray panels, and 8 px controls. The header and footer explicitly identify this as an independent, unofficial extension.
