...
The design retains familiar recipe-app conventions while using its own cream scissors icon, muted red accent (#b43e35), dark title, white header, warm gray panels, and 8 px controls. A single footer states that the extension is not affiliated with Paprika or Hindsight Labs. The popup shows one task heading, a short instruction when needed, and a compact connection row.
